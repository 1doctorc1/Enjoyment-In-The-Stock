...
if __name__ == '__main__':    
    #df=get_price('sh000001',frequency='1d',count=10)      #frequency支持'1d'日, '1w'周, '1M'月  '1m','5m','15m','30m','60m'
    df=get_price('000001.XSHG',frequency='1d',count=10,end_date='2022-06-01')     #第一个参数 证券代码 兼容多种格式
                                                    #sh000001 (000001.XSHG)    sz399006 (399006.XSHE)   sh600519 ( 600519.XSHG ) 
    print('上证指数日线行情\n',df)
    
    df=get_price('000001.XSHG',frequency='60m',count=10)  
    print('上证指数分钟线\n',df)
